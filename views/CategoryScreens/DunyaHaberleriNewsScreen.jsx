...
const DunyaNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const DunyaNews = await getArticlesByCategory("Dünya");
    setNewsData(DunyaNews);
    setLoading(false);
    console.log("First 3 articles:", DunyaNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
...
export default DunyaNewsScreen;
