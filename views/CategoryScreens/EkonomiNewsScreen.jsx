...
const EkonomiNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const EkonomiNews = await getArticlesByCategory("Ekonomi");
    setNewsData(EkonomiNews);
    setLoading(false);
    console.log("First 3 articles:", EkonomiNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
...
export default EkonomiNewsScreen;
