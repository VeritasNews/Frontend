...
const UzayNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const UzayNews = await getArticlesByCategory("Uzay");
    setNewsData(UzayNews);
    setLoading(false);
    console.log("First 3 articles:", UzayNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
