...
const TeknolojiNewsScreen = ({ navigation }) => {
    ...
    const fetchTeknolojiNews = async () => {
        setLoading(true);
        const teknolojiNews = await getArticlesByCategory("Teknoloji");
        setNewsData(teknolojiNews);
        setLoading(false);
    };
    ...
    const getFontSize = (size) => {
        switch (size) {
            ...
            case "xs": default: return { title: 14, summary: 10 };
        }
    };
...
export default TeknolojiNewsScreen;