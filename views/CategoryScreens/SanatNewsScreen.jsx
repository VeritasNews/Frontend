...
const SanatNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const SanatNews = await getArticlesByCategory("Sanat");
    setNewsData(SanatNews);
    setLoading(false);
    console.log("First 3 articles:", SanatNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
...
export default SanatNewsScreen;
