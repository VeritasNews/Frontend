...
const ModaNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const ModaNews = await getArticlesByCategory("Moda");
    setNewsData(ModaNews);
    setLoading(false);
    console.log("First 3 articles:", ModaNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
