...
const EntertainmentNewsScreen = ({ navigation }) => {
    const [newsData, setNewsData] = useState([]);  // ✅ Store fetched news
    const [loading, setLoading] = useState(true);  // ✅ Loading state
    const [portrait, setPortrait] = useState(isPortrait());

    useEffect(() => {
        fetchEntertainmentNews();  // ✅ Fetch Entertainment category news when component mounts
    ...
    // ✅ Fetch only "Entertainment" category news
    const fetchEntertainmentNews = async () => {
        setLoading(true);
        const EntertainmentNews = await getArticlesByCategory("Eglence");
