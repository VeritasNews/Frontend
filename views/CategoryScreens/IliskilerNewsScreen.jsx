...
const IliskilerNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const IliskilerNews = await getArticlesByCategory("İlişkiler");
    setNewsData(IliskilerNews);
    setLoading(false);
    console.log("First 3 articles:", IliskilerNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
...
export default IliskilerNewsScreen;
