...
const BilimNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const BilimNews = await getArticlesByCategory("Bilim");
    setNewsData(BilimNews);
    setLoading(false);
    console.log("First 3 articles:", BilimNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
...
export default BilimNewsScreen;
