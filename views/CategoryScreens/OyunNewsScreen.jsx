...
const OyunNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const OyunNews = await getArticlesByCategory("Oyun");
    setNewsData(OyunNews);
    setLoading(false);
    console.log("First 3 articles:", OyunNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
