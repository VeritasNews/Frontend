...
const YemekNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const YemekNews = await getArticlesByCategory("Yemek");
    setNewsData(YemekNews);
    setLoading(false);
    console.log("First 3 articles:", YemekNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
...
export default YemekNewsScreen;
