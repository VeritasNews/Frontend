...
const DinNewsScreen = ({ navigation }) => {
  ...
  const fetchNews = async () => {
    setLoading(true);
    const DinNews = await getArticlesByCategory("Din");
    setNewsData(DinNews);
    setLoading(false);
    console.log("First 3 articles:", DinNews.slice(0, 3).map(a => ({
        id: a.id,
        title: a.title,
        hasImage: !!a.image,
        imageUrl: a.image
